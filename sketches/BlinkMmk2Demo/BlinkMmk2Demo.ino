...
static void handle_script_cmd()
{
  Serial.print("handle_script_cmd:"); Serial.println((char)cmd);
  if( cmd == 'n' ) {
    dest = ctmp;
    curr = ctmp;
  }
    ...
    Serial.print("h:");Serial.print(cmdargs[0]); Serial.print("r:"); Serial.println(dest.r);
    fade_millis = ttmp / 2;
    calculate_overlay_inc();
  }
  else if( cmd == 'H' ) {
